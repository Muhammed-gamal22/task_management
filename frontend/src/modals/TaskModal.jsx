                    ...
                    <form onSubmit={methods.handleSubmit(onSubmit)} className="p-6 space-y-4">
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <CustomButton
                                ...
                                className="inline-flex cursor-pointer items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-semibold px-4 py-2 rounded-xl shadow-sm transition-all active:scale-95 disabled:opacity-50"
                            >
