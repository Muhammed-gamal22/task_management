        ...
        <div className="flex items-center gap-2">
            ...
            <Select value={priorityFilter} onValueChange={setPriorityFilter}>
                <SelectTrigger className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-medium rounded-xl px-3 py-2 h-auto text-slate-700 dark:text-slate-200 focus:outline-none min-w-[120px]">
                    <SelectValue className="text-white dark:text-white" placeholder="All Priorities" />
                </SelectTrigger>
                <SelectContent className="bg-white text-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg p-1 z-50">
